...
const htmlPath = path.join(__dirname, '../assets/investment-calculator.html');
const jsPath = path.join(__dirname, '../assets/investment-calculator.js');
...
const inlineScript = `
    <script type="module">
      ...
      import(url)
        .catch(err => {
          console.error('[Investment Calculator] Failed to load:', err);
          const root = document.getElementById('investment-calculator-root');
          if (root) {
